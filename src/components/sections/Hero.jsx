    ...
    <section style={{ minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', textAlign:'center', padding:'120px 24px 80px', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ position:'relative', zIndex:1, maxWidth:780 }}>
        <div style={{ display:'inline-flex', alignItems:'center', gap:6, background:'rgba(60,174,120,.1)', border:'1px solid rgba(60,174,120,.28)', color:'#5DC995', fontSize:12, fontWeight:500, padding:'6px 14px', borderRadius:99, marginBottom:26, animation:'fadeUp .6s ease both' }}>
          ...
          Plataforma Digital · Facultad de Jurisprudencia · UG
        </div>
        ...
        <p style={{ fontSize:'clamp(14px,2vw,17px)', color:'#8ABFA3', lineHeight:1.75, maxWidth:520, margin:'0 auto 38px', animation:'fadeUp .6s .2s ease both' }}>
          ACE Alianza Colectiva Estudiantil construye su sistema digital propio: eventos, comunicación, votaciones y más — todo en un solo lugar, hecho por y para estudiantes.
        </p>
        ...
        <div style={{ display:'flex', gap:44, justifyContent:'center', marginTop:68, flexWrap:'wrap', animation:'fadeUp .6s .4s ease both' }}>
          {[['6','Módulos digitales'],['8','Semanas de desarrollo'],['$0','Costo de operación'],['100%','Hecho por estudiantes']].map(([n,l])=>(
